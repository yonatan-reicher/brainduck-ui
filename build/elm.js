...
var $author$project$Interpreter$setMemoryViewSize = _Platform_outgoingPort('setMemoryViewSize', $elm$json$Json$Encode$int);
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{code: '', memoryView: _List_Nil, mode: $author$project$Main$Editing, outputStack: _List_Nil, pc: 0},
		$author$project$Interpreter$setMemoryViewSize(5));
};
var $author$project$Main$ClearOutput = {$: 'ClearOutput'};
var $author$project$Main$InputRequested = {$: 'InputRequested'};
var $author$project$Main$Output = function (a) {
	return {$: 'Output', a: a};
};
var $author$project$Main$SetModeToRun = {$: 'SetModeToRun'};
var $author$project$Main$StateChanged = function (a) {
	return {$: 'StateChanged', a: a};
};
var $author$project$Main$UndoOutput = {$: 'UndoOutput'};
...
var $author$project$Interpreter$clearOutput = _Platform_incomingPort(
	'clearOutput',
	$elm$json$Json$Decode$null(_Utils_Tuple0));
var $author$project$Interpreter$inputRequested = _Platform_incomingPort(
	'inputRequested',
	$elm$json$Json$Decode$null(_Utils_Tuple0));
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $author$project$Interpreter$output = _Platform_incomingPort('output', $elm$json$Json$Decode$int);
var $elm$json$Json$Decode$bool = _Json_decodeBool;
var $author$project$Interpreter$setCodeFinished = _Platform_incomingPort('setCodeFinished', $elm$json$Json$Decode$bool);
var $elm$json$Json$Decode$andThen = _Json_andThen;
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Interpreter$stateUpdated = _Platform_incomingPort(
	'stateUpdated',
	A2(
...
var $author$project$Interpreter$undoOutput = _Platform_incomingPort(
	'undoOutput',
	$elm$json$Json$Decode$null(_Utils_Tuple0));
var $author$project$Main$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Interpreter$setCodeFinished(
				$elm$core$Basics$always($author$project$Main$SetModeToRun)),
				$author$project$Interpreter$stateUpdated($author$project$Main$StateChanged),
				$author$project$Interpreter$inputRequested(
				$elm$core$Basics$always($author$project$Main$InputRequested)),
				$author$project$Interpreter$output($author$project$Main$Output),
				$author$project$Interpreter$undoOutput(
				$elm$core$Basics$always($author$project$Main$UndoOutput)),
				$author$project$Interpreter$clearOutput(
				$elm$core$Basics$always($author$project$Main$ClearOutput))
			]));
};
var $author$project$Main$Running = {$: 'Running'};
var $elm$json$Json$Encode$null = _Json_encodeNull;
var $author$project$Interpreter$back = _Platform_outgoingPort(
	'back',
	function ($) {
...
var $author$project$Interpreter$reset = _Platform_outgoingPort(
	'reset',
	function ($) {
		return $elm$json$Json$Encode$null;
	});
var $elm$json$Json$Encode$string = _Json_wrap;
var $author$project$Interpreter$setCode = _Platform_outgoingPort('setCode', $elm$json$Json$Encode$string);
var $author$project$Interpreter$step = _Platform_outgoingPort(
	'step',
	function ($) {
		return $elm$json$Json$Encode$null;
	});
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Back':
				return _Utils_Tuple2(
					model,
					$author$project$Interpreter$back(_Utils_Tuple0));
			case 'Reset':
				return _Utils_Tuple2(
					model,
					$author$project$Interpreter$reset(_Utils_Tuple0));
			case 'Edit':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{mode: $author$project$Main$Editing}),
					$elm$core$Platform$Cmd$none);
			case 'Run':
				return _Utils_Tuple2(
					model,
					$author$project$Interpreter$setCode(model.code));
			case 'SetModeToRun':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{mode: $author$project$Main$Running}),
					$elm$core$Platform$Cmd$none);
			case 'StateChanged':
				var pc = msg.a.pc;
				var memoryView = msg.a.memoryView;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{memoryView: memoryView, pc: pc}),
			...
			case 'Output':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							outputStack: A2($elm$core$List$cons, value, model.outputStack)
						}),
					$elm$core$Platform$Cmd$none);
			case 'UndoOutput':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							outputStack: A2($elm$core$List$drop, 1, model.outputStack)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
...
var $author$project$Main$gap = function (unit) {
	return A2(
		$rtfeldman$elm_css$Css$property,
		'gap',
		$elm$core$String$fromInt(unit) + 'px');
};
...
var $author$project$Main$myBorder = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			A3(
...
var $author$project$Main$CodeChanged = function (a) {
...
var $author$project$Main$viewCode = function (model) {
	return A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										$rtfeldman$elm_css$Css$px(0)),
										A2($rtfeldman$elm_css$Css$property, 'font-variant-ligatures', 'none'),
								...
								$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Main$CodeChanged),
								$rtfeldman$elm_css$Html$Styled$Attributes$value(model.code),
								$rtfeldman$elm_css$Html$Styled$Attributes$disabled(
								_Utils_eq(model.mode, $author$project$Main$Running))
							]),
						_List_Nil),
						A2(
						$rtfeldman$elm_css$Html$Styled$div,
							...
							[
								...
								_List_fromArray(
									[
										...
										A4($rtfeldman$elm_css$Css$rgba, 100, 100, 255, 0.5)),
										$rtfeldman$elm_css$Css$width(
										$rtfeldman$elm_css$Css$ch(1.1)),
										$rtfeldman$elm_css$Css$height(
										$rtfeldman$elm_css$Css$em(1.5)),
										$rtfeldman$elm_css$Css$left(
										$rtfeldman$elm_css$Css$ch(model.pc * 1.07777777777))
									]))
							]),
						_List_Nil)
					]))
...
var $author$project$Main$viewCommandsButtons = function (model) {
	var _v0 = model.mode;
	if (_v0.$ === 'Editing') {
		return _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Main$Run)
					]),
				_List_fromArray(
					[
		...
		return _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Main$Step)
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Main$Edit)
					]),
				_List_fromArray(
					[
...
var $author$project$Main$viewCommands = function (model) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$text('Commands'),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_Nil,
				$author$project$Main$viewCommandsButtons(model))
			]));
};
...
var $author$project$Main$viewMemoryCell = function (_v0) {
	var index = _v0.a;
	var value = _v0.b;
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
...
var $author$project$Main$viewMemory = function (model) {
	var memory = A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$text('Memory'),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
					[
				...
				A2($elm$core$List$map, $author$project$Main$viewMemoryCell, memory))
			]));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Main$gap(10)
					]))
			]),
		_List_fromArray(
			[
				$author$project$Main$viewMemory(model),
				$author$project$Main$viewCode(model),
				$author$project$Main$viewCommands(model)
			]));
};
var $elm$core$Char$fromCode = _Char_fromCode;
var $author$project$Main$outputStackToString = function (stack) {
	return $elm$core$String$fromList(
		A2(
			$elm$core$List$map,
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text(
						$author$project$Main$outputStackToString(model.outputStack))
					]))
			]));
};
